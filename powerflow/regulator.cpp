...
regulator::regulator(MODULE *mod) : link_object(mod)
{
	if (oclass==nullptr)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_int16, "initial_tap_A", PADDR(initial_tap_A), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: initial tap position of phase A",
			PT_int16, "initial_tap_B", PADDR(initial_tap_B), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: initial tap position of phase B",
			PT_int16, "initial_tap_C", PADDR(initial_tap_C), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: initial tap position of phase C",
			PT_int16, "tap_A_changed", PADDR(tap_A_changed), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: phase A tap changed indicator",
			PT_int16, "tap_B_changed", PADDR(tap_B_changed), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: phase B tap changed indicator",
			PT_int16, "tap_C_changed", PADDR(tap_C_changed), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: phase C tap changed indicator",
			PT_int16, "prev_tap_A", PADDR(prev_tap_A), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous tap position of phase A",
			PT_int16, "prev_tap_B", PADDR(prev_tap_B), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous tap position of phase B",
			PT_int16, "prev_tap_C", PADDR(prev_tap_C), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: previous tap position of phase C",
			PT_double, "mech_t_next_A", PADDR(mech_t_next[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: next mechanical tap-change time for phase A",
			PT_double, "mech_t_next_B", PADDR(mech_t_next[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: next mechanical tap-change time for phase B",
			PT_double, "mech_t_next_C", PADDR(mech_t_next[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: next mechanical tap-change time for phase C",
			PT_double, "dwell_t_next_A", PADDR(dwell_t_next[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: next dwell expiration time for phase A",
			PT_double, "dwell_t_next_B", PADDR(dwell_t_next[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: next dwell expiration time for phase B",
			PT_double, "dwell_t_next_C", PADDR(dwell_t_next[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: next dwell expiration time for phase C",
			PT_int16, "mech_flag_A", PADDR(mech_flag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: mechanical state flag for phase A",
			PT_int16, "mech_flag_B", PADDR(mech_flag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: mechanical state flag for phase B",
			PT_int16, "mech_flag_C", PADDR(mech_flag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: mechanical state flag for phase C",
			PT_int16, "dwell_flag_A", PADDR(dwell_flag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: dwell state flag for phase A",
			PT_int16, "dwell_flag_B", PADDR(dwell_flag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: dwell state flag for phase B",
			PT_int16, "dwell_flag_C", PADDR(dwell_flag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: dwell state flag for phase C",
			PT_int16, "first_run_flag_A", PADDR(first_run_flag[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: first-run indicator for phase A",
			PT_int16, "first_run_flag_B", PADDR(first_run_flag[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: first-run indicator for phase B",
			PT_int16, "first_run_flag_C", PADDR(first_run_flag[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: first-run indicator for phase C",
			PT_bool, "toggle_reverse_flow_A", PADDR(toggle_reverse_flow[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: reverse-flow toggle state for phase A",
			PT_bool, "toggle_reverse_flow_B", PADDR(toggle_reverse_flow[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: reverse-flow toggle state for phase B",
			PT_bool, "toggle_reverse_flow_C", PADDR(toggle_reverse_flow[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: reverse-flow toggle state for phase C",
			PT_bool, "toggle_reverse_flow_banked", PADDR(toggle_reverse_flow_banked), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: reverse-flow toggle state for banked operation",
			PT_int16, "reverse_flow_tap_A", PADDR(reverse_flow_tap[0]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: reverse-flow tap value for phase A",
			PT_int16, "reverse_flow_tap_B", PADDR(reverse_flow_tap[1]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: reverse-flow tap value for phase B",
			PT_int16, "reverse_flow_tap_C", PADDR(reverse_flow_tap[2]), PT_ACCESS, PA_HIDDEN, PT_DESCRIPTION, "CHECKPOINT VAR: reverse-flow tap value for phase C",
